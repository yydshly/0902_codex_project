...
- 验证目标：展示五个真实 World、3D 资产墙、共享 Runtime、原子 Portal、自适应画质和静态降级；再用当前仓库 001–006 的真实项目证明这套架构如何转化为个人品牌系统。
...
新增的“真实品牌系统”直接读取根目录 `catalog/projects.json`，将六个项目映射为五类能力证据：视觉计算、交互产品、Agent 工作流、数据系统和设计研究。用户可以按能力筛选、选择项目，并在页面内加载对应的真实 Demo。
